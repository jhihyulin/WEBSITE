    ...
    if (_lURLformKey.currentState!.validate()) {
      ...
      await http
          .post(lURLServerCreate,
              body: jsonEncode({'firebase_uid': uid, 'original_url': lURLURLController.text}),
                                                    ...
                                                    children: [
                                                      Offstage(
                                                        ...
                                                        child: Text.rich(
                                                          TextSpan(
                                                            children: [
                                                              const TextSpan(text: 'The URL you generated is '),
                                                              TextSpan(
                                                                text: '$_lURLLength',
                                                              ...
                                                              const TextSpan(text: ' to shorten the original URL before generating Long URL.'),
                                                            ],
                                                          ),
                                                        ),
                                                      ),

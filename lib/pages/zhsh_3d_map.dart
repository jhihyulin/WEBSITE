...
const Map settingData = {
  ...
  'object': {
    'set': {
      ...
      'build1_1f_room': {'name': '行政大樓1F未知空間'},// TODO: check relative position 1F
      'build1_2f_room': {'name': '行政大樓2F油印室'},
      'build1_3f_room': {'name': '行政大樓3F未知空間'},// TODO: Confirmation use
      'build1_4f_room': {'name': '行政大樓4F茶水間'},
      'build1_5f_room': {'name': '行政大樓5F未知空間'},// TODO: Confirmation use
      'build1_6f_room': {'name': '行政大樓6F未知空間'},// TODO: Confirmation use
      'build1_7f_room': {'name': '行政大樓7F未知空間'},// TODO: Confirmation use

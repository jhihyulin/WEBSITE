...
const Map<String, Map<String, dynamic>> mapData = {
  // build
  'build_base2': {'x': 13, 'y': 0, 'z': 61, 'height': 1, 'width': 6, 'length': 5},
  'build_1f': {'floor': 1, 'x': 13, 'y': 1, 'z': 51.5, 'height': 4, 'width': 13, 'length': 5},
  'build_2f': {'floor': 2, 'x': 13, 'y': 5, 'z': 51.5, 'height': 3, 'width': 13, 'length': 5},
  'build_3f': {'floor': 3, 'x': 13, 'y': 8, 'z': 51.5, 'height': 3, 'width': 13, 'length': 5},
  'build_4f': {'floor': 4, 'x': 13, 'y': 11, 'z': 51.5, 'height': 3, 'width': 13, 'length': 5},
  'build_5f': {'floor': 5, 'x': 13, 'y': 14, 'z': 51.5, 'height': 3, 'width': 13, 'length': 5},
  'build_6f': {'floor': 6, 'x': 13, 'y': 17, 'z': 51.5, 'height': 3, 'width': 13, 'length': 5},
  'build_7f': {'floor': 7, 'x': 13, 'y': 20, 'z': 51.5, 'height': 3, 'width': 13, 'length': 5},
  'build_stair': {
    'x': 13,
    'y': 1,
    'z': 61,
  ...
  // build1
  'build1_base': {'build': 'build1', 'x': -12, 'y': 0, 'z': 52.5, 'height': 1, 'width': 15, 'length': 5},
  'build1_base_###1': {
    'build': 'build1',
    'x': -10.5,
    'y': 0,
  ...
  'build1_base_###2': {'build': 'build1', 'x': -14.1, 'y': 0, 'z': 67.5, 'height': 1, 'width': 15, 'length': 0.8},
  'build1_base_###3': {'build': 'build1', 'x': -11.6, 'y': 0, 'z': 67.5, 'height': 2, 'width': 15, 'length': 0.2},
  'build1_stair': {'build': 'build1', 'x': -10, 'y': 0, 'z': 42.5, 'height': 29, 'width': 5, 'length': 9},
  'build1_stair1': {'build': 'build1', 'x': -10.5, 'y': 0, 'z': 74.4, 'height': 0.2, 'width': 0.8, 'length': 2},
  'build1_stair1_###1': {'build': 'build1', 'x': -10.5, 'y': 0.2, 'z': 74.3, 'height': 0.2, 'width': 0.6, 'length': 2},
  'build1_stair1_###2': {'build': 'build1', 'x': -10.5, 'y': 0.4, 'z': 74.2, 'height': 0.2, 'width': 0.4, 'length': 2},
  'build1_stair1_###3': {'build': 'build1', 'x': -10.5, 'y': 0.6, 'z': 74.1, 'height': 0.2, 'width': 0.2, 'length': 2},
  'build1_ramp': {
    'build': 'build1',
    'x': -12.7,
    'y': -0.5,
  ...
  'build1_elevator': {'build': 'build1', 'x': -4, 'y': -2, 'z': 42.5, 'height': 29, 'width': 5, 'length': 3},
  'build1_colunm': {'build': 'build1', 'x': -14.1, 'y': 1, 'z': 74.6, 'height': 10, 'width': 0.8, 'length': 0.8},
  'build1_colunm_###1': {'build': 'build1', 'x': -14.1, 'y': 1, 'z': 69.7, 'height': 10, 'width': 0.8, 'length': 0.8},
  'build1_colunm_###2': {'build': 'build1', 'x': -14.1, 'y': 1, 'z': 64.8, 'height': 7, 'width': 0.8, 'length': 0.8},
  'build1_colunm_###3': {'build': 'build1', 'x': -14.1, 'y': 1, 'z': 59.9, 'height': 7, 'width': 0.8, 'length': 0.8},
  'build1_colunm_###4': {'build': 'build1', 'x': -14.1, 'y': 1, 'z': 55, 'height': 7, 'width': 0.8, 'length': 0.8},
  'build1_colunm_###5': {'build': 'build1', 'x': -14.1, 'y': 1, 'z': 50.1, 'height': 7, 'width': 0.8, 'length': 0.8},
  'build1_beam': {'build': 'build1', 'x': -11.6, 'y': 5, 'z': 74.6, 'height': 0.5, 'width': 0.5, 'length': 4.2},
  'build1_beam_###1': {'build': 'build1', 'x': -14.1, 'y': 5, 'z': 72.15, 'height': 0.5, 'width': 4.1, 'length': 0.5},
  'build1_beam_###2': {'build': 'build1', 'x': -14.1, 'y': 5, 'z': 67.25, 'height': 0.5, 'width': 4.1, 'length': 0.5},
  'build1_beam_###3': {'build': 'build1', 'x': -14.1, 'y': 5, 'z': 62.35, 'height': 0.5, 'width': 4.1, 'length': 0.5},
  'build1_beam_###4': {'build': 'build1', 'x': -14.1, 'y': 5, 'z': 57.45, 'height': 0.5, 'width': 4.1, 'length': 0.5},
  'build1_beam_###5': {'build': 'build1', 'x': -14.1, 'y': 5, 'z': 52.55, 'height': 0.5, 'width': 4.1, 'length': 0.5},
  'build1_beam_###6': {'build': 'build1', 'x': -14.1, 'y': 5, 'z': 47.35, 'height': 0.5, 'width': 4.7, 'length': 0.5},
  'build1_beam_###7': {'build': 'build1', 'x': -11.6, 'y': 7, 'z': 74.6, 'height': 2, 'width': 0.5, 'length': 4.2},
  'build1_beam_###8': {'build': 'build1', 'x': -14.1, 'y': 7, 'z': 72.15, 'height': 2, 'width': 4.1, 'length': 0.5},
  'build1_beam_###9': {'build': 'build1', 'x': -14.1, 'y': 7, 'z': 67.25, 'height': 2, 'width': 4.1, 'length': 0.5},
  'build1_beam_###10': {'build': 'build1', 'x': -11.6, 'y': 5, 'z': 69.7, 'height': 0.5, 'width': 0.5, 'length': 4.2},
  'build1_beam_###11': {'build': 'build1', 'x': -11.6, 'y': 5, 'z': 64.8, 'height': 0.5, 'width': 0.5, 'length': 4.2},
  'build1_beam_###12': {'build': 'build1', 'x': -11.6, 'y': 5, 'z': 59.9, 'height': 0.5, 'width': 0.5, 'length': 4.2},
  'build1_beam_###13': {'build': 'build1', 'x': -11.6, 'y': 5, 'z': 55, 'height': 0.5, 'width': 0.5, 'length': 4.2},
  'build1_beam_###14': {'build': 'build1', 'x': -11.6, 'y': 5, 'z': 50.1, 'height': 0.5, 'width': 0.5, 'length': 4.2},
  'build1_stairgate': {'build': 'build1', 'x': -14.9, 'y': 0, 'z': 55, 'height': 0.2, 'width': 9.8, 'length': 0.8},
  'build1_stairgate_###1': {'build': 'build1', 'x': -14.8, 'y': 0.2, 'z': 55, 'height': 0.2, 'width': 9.8, 'length': 0.6},
  'build1_stairgate_###2': {'build': 'build1', 'x': -14.7, 'y': 0.4, 'z': 55, 'height': 0.2, 'width': 9.8, 'length': 0.4},
  'build1_stairgate_###3': {'build': 'build1', 'x': -14.6, 'y': 0.6, 'z': 55, 'height': 0.2, 'width': 9.8, 'length': 0.2},
  'build1_facade': {'build': 'build1', 'x': -9.25, 'y': 1, 'z': 47, 'height': 7, 'width': 4, 'length': 0.5},
  'build1_facade_###1': {'build': 'build1', 'x': -14.1, 'y': 1, 'z': 72.15, 'height': 0.7, 'width': 4.1, 'length': 0.5},
  'build1_facade_###2': {'build': 'build1', 'x': -14.1, 'y': 1, 'z': 67.25, 'height': 0.7, 'width': 4.1, 'length': 0.5},
  'build1_facade_###3': {'build': 'build1', 'x': -14.1, 'y': 1, 'z': 62.35, 'height': 0.7, 'width': 4.1, 'length': 0.5},
  'build1_facade_###4': {'build': 'build1', 'x': -14.1, 'y': 1, 'z': 47.35, 'height': 0.7, 'width': 4.7, 'length': 0.5},
  'build1_gate': {'build': 'build1', 'x': -9.25, 'y': 1, 'z': 54.5, 'height': 4, 'width': 11, 'length': 0.5, 'opacity': 0.2},
  // build1_b1
  'build1_b1_room1': {
    'build': 'build1',
    'x': 0.5,
  ...
  'build1_b1_room1_###extend': {'x': 13, 'y': -2, 'z': 49, 'height': 3, 'width': 18, 'length': 5},
  // build1_1f
  'build1_1f_room': {
    'build': 'build1',
    'x': 9,
  ...
  'build1_3f_extend': {'x': -15.25, 'y': 8, 'z': 55, 'height': 1.5, 'width': 14, 'length': 1.5},
  'build1_3f_room3': {
    'build': 'build1',
    'x': -12,
    'y': 8,
  ...
  // build2
  'build2_base1': {'build': 'build2', 'x': 28.5, 'y': 0, 'z': 51.5, 'height': 1, 'width': 13, 'length': 26},
  'build2_1f_room1': {'floor': 1, 'build': 'build2', 'x': 25, 'y': 1, 'z': 51.5, 'height': 3, 'width': 13, 'length': 19},
  'build2_2f_room1': {'floor': 2, 'build': 'build2', 'x': 25, 'y': 4, 'z': 51.5, 'height': 3, 'width': 13, 'length': 19},
  'build2_3f_room1': {'floor': 3, 'build': 'build2', 'x': 25, 'y': 7, 'z': 51.5, 'height': 3, 'width': 13, 'length': 19},
  'build2_4f_room1': {'floor': 4, 'build': 'build2', 'x': 25, 'y': 10, 'z': 51.5, 'height': 3, 'width': 13, 'length': 19},
  'build2_5f_room1': {'floor': 5, 'build': 'build2', 'x': 25, 'y': 13, 'z': 51.5, 'height': 3, 'width': 13, 'length': 19},
  'build2_1f_toilet1': {'floor': 1, 'build': 'build2', 'x': 38, 'y': 1, 'z': 51.5, 'height': 3, 'width': 13, 'length': 7},
  'build2_2f_toilet1': {'floor': 2, 'build': 'build2', 'x': 38, 'y': 4, 'z': 51.5, 'height': 3, 'width': 13, 'length': 7},
  'build2_3f_toilet1': {'floor': 3, 'build': 'build2', 'x': 38, 'y': 7, 'z': 51.5, 'height': 3, 'width': 13, 'length': 7},
  'build2_4f_toilet1': {'floor': 4, 'build': 'build2', 'x': 38, 'y': 10, 'z': 51.5, 'height': 3, 'width': 13, 'length': 7},
  'build2_5f_toilet1': {'floor': 5, 'build': 'build2', 'x': 38, 'y': 13, 'z': 51.5, 'height': 3, 'width': 13, 'length': 7},
  ...
  'build3_stair3': {'build': 'build3', 'x': 48.5, 'y': -2, 'z': -22, 'height': 21, 'width': 4, 'length': 14},
  // build3_b1
  'build3_b1_aisle1': {'floor': -1, 'build': 'build3', 'x': 44.5, 'y': -2, 'z': 24, 'height': 3, 'width': 16, 'length': 6},
  'build3_b1_room1': {'floor': -1, 'build': 'build3', 'x': 49.5, 'y': -2, 'z': 13.75, 'height': 3, 'width': 4.5, 'length': 16},
  'build3_b1_room2': {'floor': -1, 'build': 'build3', 'x': 49.5, 'y': -2, 'z': 9.25, 'height': 3, 'width': 4.5, 'length': 16},
  'build3_b1_room3': {'floor': -1, 'build': 'build3', 'x': 49.5, 'y': -2, 'z': 2.5, 'height': 3, 'width': 9, 'length': 16},
  'build3_b1_room4': {'floor': -1, 'build': 'build3', 'x': 49.5, 'y': -2, 'z': -11, 'height': 3, 'width': 18, 'length': 16},
  'build3_b1_room5': {'floor': -1, 'build': 'build3', 'x': 54.5, 'y': -2, 'z': 24, 'height': 3, 'width': 16, 'length': 6},
  'build3_base1': {'build': 'build3', 'x': 40, 'y': 0, 'z': 66.5, 'height': 1, 'width': 17, 'length': 11, 'searchable': false},
  'build3_base2': {'build': 'build3', 'x': 47.5, 'y': 0, 'z': 40.5, 'height': 1, 'width': 17, 'length': 12},
  'build3_base3': {
    'build': 'build3',
    'x': 45,
    'y': 0,
  ...
  // build3_1f
  'build3_1f_room1': {'floor': 1, 'build': 'build3', 'x': 40, 'y': 1, 'z': 66.5, 'height': 3, 'width': 17, 'length': 11},
  'build3_1f_room2': {'floor': 1, 'build': 'build3', 'x': 47.5, 'y': 1, 'z': 40.5, 'height': 3, 'width': 17, 'length': 12},
  'build3_1f_toilet1': {'floor': 1, 'build': 'build3', 'x': 54.5, 'y': 1, 'z': 24, 'height': 3, 'width': 16, 'length': 6},
  'build3_1f_aisle1': {'floor': 1, 'build': 'build3', 'x': 44.5, 'y': 1, 'z': 24, 'height': 3, 'width': 16, 'length': 6},
  'build3_1f_room3': {'floor': 1, 'build': 'build3', 'x': 49.5, 'y': 1, 'z': 11.5, 'height': 3, 'width': 9, 'length': 16},
  'build3_1f_room4': {'floor': 1, 'build': 'build3', 'x': 49.5, 'y': 1, 'z': 2.5, 'height': 3, 'width': 9, 'length': 16},
  'build3_1f_room5': {'floor': 1, 'build': 'build3', 'x': 49.5, 'y': 1, 'z': -6.5, 'height': 3, 'width': 9, 'length': 16},
  'build3_1f_room6': {'floor': 1, 'build': 'build3', 'x': 49.5, 'y': 1, 'z': -15.5, 'height': 3, 'width': 9, 'length': 16},
  'build3_1f_toilet2': {'floor': 1, 'build': 'build3', 'x': 48.5, 'y': 1, 'z': -30, 'height': 3, 'width': 12, 'length': 14},
  // build3_2f
  'build3_2f_room1': {'floor': 2, 'build': 'build3', 'x': 40, 'y': 4, 'z': 66.5, 'height': 3, 'width': 17, 'length': 11},
  'build3_2f_room2': {'floor': 2, 'build': 'build3', 'x': 47.5, 'y': 4, 'z': 40.5, 'height': 3, 'width': 17, 'length': 12},
  'build3_2f_toilet1': {'floor': 2, 'build': 'build3', 'x': 54.5, 'y': 4, 'z': 24, 'height': 3, 'width': 16, 'length': 6},
  'build3_2f_aisle1': {'floor': 2, 'build': 'build3', 'x': 44.5, 'y': 4, 'z': 24, 'height': 3, 'width': 16, 'length': 6},
  'build3_2f_room3': {'floor': 2, 'build': 'build3', 'x': 49.5, 'y': 4, 'z': 11.5, 'height': 3, 'width': 9, 'length': 16},
  'build3_2f_room4': {'floor': 2, 'build': 'build3', 'x': 49.5, 'y': 4, 'z': 2.5, 'height': 3, 'width': 9, 'length': 16},
  'build3_2f_room5': {'floor': 2, 'build': 'build3', 'x': 49.5, 'y': 4, 'z': -6.5, 'height': 3, 'width': 9, 'length': 16},
  'build3_2f_room6': {'floor': 2, 'build': 'build3', 'x': 49.5, 'y': 4, 'z': -15.5, 'height': 3, 'width': 9, 'length': 16},
  'build3_2f_toilet2': {'floor': 2, 'build': 'build3', 'x': 48.5, 'y': 4, 'z': -30, 'height': 3, 'width': 12, 'length': 14},
  // build3_3f
  'build3_3f_room1': {'floor': 3, 'build': 'build3', 'x': 40, 'y': 7, 'z': 66.5, 'height': 3, 'width': 17, 'length': 11},
  'build3_3f_room2': {'floor': 3, 'build': 'build3', 'x': 47.5, 'y': 7, 'z': 40.5, 'height': 3, 'width': 17, 'length': 12},
  'build3_3f_toilet1': {'floor': 3, 'build': 'build3', 'x': 54.5, 'y': 7, 'z': 24, 'height': 3, 'width': 16, 'length': 6},
  'build3_3f_aisle1': {'floor': 3, 'build': 'build3', 'x': 44.5, 'y': 7, 'z': 24, 'height': 3, 'width': 16, 'length': 6},
  'build3_3f_room3': {'floor': 3, 'build': 'build3', 'x': 49.5, 'y': 7, 'z': 11.5, 'height': 3, 'width': 9, 'length': 16},
  'build3_3f_room4': {'floor': 3, 'build': 'build3', 'x': 49.5, 'y': 7, 'z': 2.5, 'height': 3, 'width': 9, 'length': 16},
  'build3_3f_room5': {'floor': 3, 'build': 'build3', 'x': 49.5, 'y': 7, 'z': -6.5, 'height': 3, 'width': 9, 'length': 16},
  'build3_3f_room6': {'floor': 3, 'build': 'build3', 'x': 49.5, 'y': 7, 'z': -15.5, 'height': 3, 'width': 9, 'length': 16},
  'build3_3f_toilet2': {'floor': 3, 'build': 'build3', 'x': 48.5, 'y': 7, 'z': -30, 'height': 3, 'width': 12, 'length': 14},
  // build3_4f
  'build3_4f_room1': {'floor': 4, 'build': 'build3', 'x': 40, 'y': 10, 'z': 66.5, 'height': 3, 'width': 17, 'length': 11},
  'build3_4f_room2': {'floor': 4, 'build': 'build3', 'x': 47.5, 'y': 10, 'z': 40.5, 'height': 3, 'width': 17, 'length': 12},
  'build3_4f_toilet1': {'floor': 4, 'build': 'build3', 'x': 54.5, 'y': 10, 'z': 24, 'height': 3, 'width': 16, 'length': 6},
  'build3_4f_aisle1': {'floor': 4, 'build': 'build3', 'x': 44.5, 'y': 10, 'z': 24, 'height': 3, 'width': 16, 'length': 6},
  'build3_4f_room3': {
    'floor': 4,
    'build': 'build3',
    'x': 49.5,
  ...
  //   'length': 16
  // },
  'build3_4f_room5': {'floor': 4, 'build': 'build3', 'x': 49.5, 'y': 10, 'z': -6.5, 'height': 3, 'width': 9, 'length': 16},
  'build3_4f_room6': {'floor': 4, 'build': 'build3', 'x': 49.5, 'y': 10, 'z': -15.5, 'height': 3, 'width': 9, 'length': 16},
  'build3_4f_toilet2': {'floor': 4, 'build': 'build3', 'x': 48.5, 'y': 10, 'z': -30, 'height': 3, 'width': 12, 'length': 14},
  // build3_5f
  'build3_5f_room1': {'floor': 5, 'build': 'build3', 'x': 40, 'y': 13, 'z': 66.5, 'height': 3, 'width': 17, 'length': 11},
  'build3_5f_room2': {'floor': 5, 'build': 'build3', 'x': 47.5, 'y': 13, 'z': 40.5, 'height': 3, 'width': 17, 'length': 12},
  'build3_5f_toilet1': {'floor': 5, 'build': 'build3', 'x': 54.5, 'y': 13, 'z': 24, 'height': 3, 'width': 16, 'length': 6},
  'build3_5f_aisle1': {'floor': 5, 'build': 'build3', 'x': 44.5, 'y': 13, 'z': 24, 'height': 3, 'width': 16, 'length': 6},
  'build3_5f_room3': {'floor': 5, 'build': 'build3', 'x': 49.5, 'y': 13, 'z': 11.5, 'height': 3, 'width': 9, 'length': 16},
  'build3_5f_room4': {
    'floor': 5,
    'build': 'build3',
    'x': 49.5,
  ...
  'build3_5f_toilet2': {'floor': 5, 'build': 'build3', 'x': 48.5, 'y': 13, 'z': -30, 'height': 3, 'width': 12, 'length': 14},

  // build4
  'build4_stair1': {'build': 'build4', 'x': -22, 'y': -2, 'z': -19.5, 'height': 18, 'width': 10, 'length': 10},
  // build4_b1
  'build4_b1_room1': {'floor': -1, 'build': 'build4', 'x': 10, 'y': -2, 'z': -28, 'height': 3, 'width': 16, 'length': 63},
  'build4_b1_room1_###1': {'floor': -1, 'build': 'build4', 'x': 48.5, 'y': -2, 'z': -30, 'height': 3, 'width': 12, 'length': 14},
  // build4_1f
  'build4_1f_room1': {'floor': 1, 'build': 'build4', 'x': 37, 'y': 1, 'z': -28, 'height': 3, 'width': 16, 'length': 9},
  'build4_1f_room2': {'floor': 1, 'build': 'build4', 'x': 28, 'y': 1, 'z': -28, 'height': 3, 'width': 16, 'length': 9},
  'build4_1f_aisle1': {'floor': 1, 'build': 'build4', 'x': 21.25, 'y': 1, 'z': -28, 'height': 3, 'width': 16, 'length': 4.5},
  'build4_1f_room3': {'floor': 1, 'build': 'build4', 'x': 14.5, 'y': 1, 'z': -28, 'height': 3, 'width': 16, 'length': 9},
  'build4_1f_room4': {'floor': 1, 'build': 'build4', 'x': 5.5, 'y': 1, 'z': -28, 'height': 3, 'width': 16, 'length': 9},
  'build4_1f_room5': {'floor': 1, 'build': 'build4', 'x': -3.5, 'y': 1, 'z': -28, 'height': 3, 'width': 16, 'length': 9},
  'build4_1f_room6': {'floor': 1, 'build': 'build4', 'x': -12.5, 'y': 1, 'z': -28, 'height': 3, 'width': 16, 'length': 9},
  'build4_1f_aisle2': {'floor': 1, 'build': 'build4', 'x': -19.25, 'y': 1, 'z': -30.25, 'height': 3, 'width': 11.5, 'length': 4.5},
  // build4_2f
  'build4_2f_room1': {'floor': 2, 'build': 'build4', 'x': 37, 'y': 4, 'z': -28, 'height': 3, 'width': 16, 'length': 9},
  'build4_2f_room2': {'floor': 2, 'build': 'build4', 'x': 28, 'y': 4, 'z': -28, 'height': 3, 'width': 16, 'length': 9},
  'build4_2f_aisle1': {'floor': 2, 'build': 'build4', 'x': 21.25, 'y': 4, 'z': -28, 'height': 3, 'width': 16, 'length': 4.5},
  'build4_2f_room3': {'floor': 2, 'build': 'build4', 'x': 14.5, 'y': 4, 'z': -28, 'height': 3, 'width': 16, 'length': 9},
  'build4_2f_room4': {'floor': 2, 'build': 'build4', 'x': 5.5, 'y': 4, 'z': -28, 'height': 3, 'width': 16, 'length': 9},
  'build4_2f_room5': {'floor': 2, 'build': 'build4', 'x': -3.5, 'y': 4, 'z': -28, 'height': 3, 'width': 16, 'length': 9},
  'build4_2f_room6': {'floor': 2, 'build': 'build4', 'x': -12.5, 'y': 4, 'z': -28, 'height': 3, 'width': 16, 'length': 9},
  'build4_2f_aisle2': {'floor': 2, 'build': 'build4', 'x': -19.25, 'y': 4, 'z': -30.25, 'height': 3, 'width': 11.5, 'length': 4.5},
  // build4_3f
  'build4_3f_room1': {'floor': 3, 'build': 'build4', 'x': 37, 'y': 7, 'z': -28, 'height': 3, 'width': 16, 'length': 9},
  'build4_3f_room2': {'floor': 3, 'build': 'build4', 'x': 28, 'y': 7, 'z': -28, 'height': 3, 'width': 16, 'length': 9},
  'build4_3f_aisle1': {'floor': 3, 'build': 'build4', 'x': 21.25, 'y': 7, 'z': -28, 'height': 3, 'width': 16, 'length': 4.5},
  'build4_3f_room3': {'floor': 3, 'build': 'build4', 'x': 14.5, 'y': 7, 'z': -28, 'height': 3, 'width': 16, 'length': 9},
  'build4_3f_room4': {'floor': 3, 'build': 'build4', 'x': 5.5, 'y': 7, 'z': -28, 'height': 3, 'width': 16, 'length': 9},
  'build4_3f_room5': {'floor': 3, 'build': 'build4', 'x': -3.5, 'y': 7, 'z': -28, 'height': 3, 'width': 16, 'length': 9},
  'build4_3f_room6': {'floor': 3, 'build': 'build4', 'x': -12.5, 'y': 7, 'z': -28, 'height': 3, 'width': 16, 'length': 9},
  'build4_3f_aisle2': {'floor': 3, 'build': 'build4', 'x': -19.25, 'y': 7, 'z': -30.25, 'height': 3, 'width': 11.5, 'length': 4.5},
  // build4_4f
  'build4_4f_room1': {'floor': 4, 'build': 'build4', 'x': 37, 'y': 10, 'z': -28, 'height': 3, 'width': 16, 'length': 9},
  'build4_4f_room2': {'floor': 4, 'build': 'build4', 'x': 28, 'y': 10, 'z': -28, 'height': 3, 'width': 16, 'length': 9},
  'build4_4f_aisle1': {'floor': 4, 'build': 'build4', 'x': 21.25, 'y': 10, 'z': -28, 'height': 3, 'width': 16, 'length': 4.5},
  'build4_4f_room3': {'floor': 4, 'build': 'build4', 'x': 14.5, 'y': 10, 'z': -28, 'height': 3, 'width': 16, 'length': 9},
  'build4_4f_room4': {'floor': 4, 'build': 'build4', 'x': 5.5, 'y': 10, 'z': -28, 'height': 3, 'width': 16, 'length': 9},
  'build4_4f_room5': {'floor': 4, 'build': 'build4', 'x': -3.5, 'y': 10, 'z': -28, 'height': 3, 'width': 16, 'length': 9},
  'build4_4f_room6': {'floor': 4, 'build': 'build4', 'x': -12.5, 'y': 10, 'z': -28, 'height': 3, 'width': 16, 'length': 9},
  'build4_4f_aisle2': {'floor': 4, 'build': 'build4', 'x': -19.25, 'y': 10, 'z': -30.25, 'height': 3, 'width': 11.5, 'length': 4.5},
  // build4_5f
  'build4_5f_room1': {'floor': 5, 'build': 'build4', 'x': 37, 'y': 13, 'z': -28, 'height': 3, 'width': 16, 'length': 9},
  'build4_5f_room2': {'floor': 5, 'build': 'build4', 'x': 28, 'y': 13, 'z': -28, 'height': 3, 'width': 16, 'length': 9},
  'build4_5f_aisle1': {'floor': 5, 'build': 'build4', 'x': 21.25, 'y': 13, 'z': -28, 'height': 3, 'width': 16, 'length': 4.5},
  'build4_5f_room3': {'floor': 5, 'build': 'build4', 'x': 14.5, 'y': 13, 'z': -28, 'height': 3, 'width': 16, 'length': 9},
  'build4_5f_room4': {'floor': 5, 'build': 'build4', 'x': 5.5, 'y': 13, 'z': -28, 'height': 3, 'width': 16, 'length': 9},
  'build4_5f_room5': {'floor': 5, 'build': 'build4', 'x': -3.5, 'y': 13, 'z': -28, 'height': 3, 'width': 16, 'length': 9},
  'build4_5f_room6': {'floor': 5, 'build': 'build4', 'x': -12.5, 'y': 13, 'z': -28, 'height': 3, 'width': 16, 'length': 9},
  'build4_5f_aisle2': {'floor': 5, 'build': 'build4', 'x': -19.25, 'y': 13, 'z': -30.25, 'height': 3, 'width': 11.5, 'length': 4.5},

  // build5
  'build5_stair1': {'build': 'build5', 'x': -22, 'y': -2, 'z': 15.5, 'height': 18, 'width': 10, 'length': 10},
  // build5_b1
  'build5_b1_room1': {'floor': -1, 'build': 'build5', 'x': 37, 'y': -2, 'z': 24, 'height': 3, 'width': 16, 'length': 9},
  'build5_b1_room2': {'floor': -1, 'build': 'build5', 'x': 5.5, 'y': -2, 'z': 24, 'height': 3, 'width': 16, 'length': 54},
  // build5_1f
  'build5_1f_room1': {'floor': 1, 'build': 'build5', 'x': 37, 'y': 1, 'z': 24, 'height': 3, 'width': 16, 'length': 9},
  'build5_1f_room2': {'floor': 1, 'build': 'build5', 'x': 28, 'y': 1, 'z': 24, 'height': 3, 'width': 16, 'length': 9},
  'build5_1f_aisle1': {'floor': 1, 'build': 'build5', 'x': 21.25, 'y': 1, 'z': 24, 'height': 3, 'width': 16, 'length': 4.5},
  'build5_1f_room3': {'floor': 1, 'build': 'build5', 'x': 14.5, 'y': 1, 'z': 24, 'height': 3, 'width': 16, 'length': 9},
  'build5_1f_room4': {'floor': 1, 'build': 'build5', 'x': 5.5, 'y': 1, 'z': 24, 'height': 3, 'width': 16, 'length': 9},
  'build5_1f_room5': {'floor': 1, 'build': 'build5', 'x': -3.5, 'y': 1, 'z': 24, 'height': 3, 'width': 16, 'length': 9},
  'build5_1f_room6': {'floor': 1, 'build': 'build5', 'x': -12.5, 'y': 1, 'z': 24, 'height': 3, 'width': 16, 'length': 9},
  'build5_1f_aisle2': {'floor': 1, 'build': 'build5', 'x': -19.25, 'y': 1, 'z': 26.25, 'height': 3, 'width': 11.5, 'length': 4.5},
  // build5_2f
  'build5_2f_room1': {'floor': 2, 'build': 'build5', 'x': 37, 'y': 4, 'z': 24, 'height': 3, 'width': 16, 'length': 9},
  'build5_2f_room2': {'floor': 2, 'build': 'build5', 'x': 28, 'y': 4, 'z': 24, 'height': 3, 'width': 16, 'length': 9},
  'build5_2f_aisle1': {'floor': 2, 'build': 'build5', 'x': 21.25, 'y': 4, 'z': 24, 'height': 3, 'width': 16, 'length': 4.5},
  'build5_2f_room3': {'floor': 2, 'build': 'build5', 'x': 14.5, 'y': 4, 'z': 24, 'height': 3, 'width': 16, 'length': 9},
  'build5_2f_room4': {'floor': 2, 'build': 'build5', 'x': 5.5, 'y': 4, 'z': 24, 'height': 3, 'width': 16, 'length': 9},
  'build5_2f_room5': {'floor': 2, 'build': 'build5', 'x': -3.5, 'y': 4, 'z': 24, 'height': 3, 'width': 16, 'length': 9},
  'build5_2f_room6': {'floor': 2, 'build': 'build5', 'x': -12.5, 'y': 4, 'z': 24, 'height': 3, 'width': 16, 'length': 9},
  'build5_2f_aisle2': {'floor': 2, 'build': 'build5', 'x': -19.25, 'y': 4, 'z': 26.25, 'height': 3, 'width': 11.5, 'length': 4.5},
  // build5_3f
  'build5_3f_room1': {'floor': 3, 'build': 'build5', 'x': 37, 'y': 7, 'z': 24, 'height': 3, 'width': 16, 'length': 9},
  'build5_3f_room2': {'floor': 3, 'build': 'build5', 'x': 28, 'y': 7, 'z': 24, 'height': 3, 'width': 16, 'length': 9},
  'build5_3f_aisle1': {'floor': 3, 'build': 'build5', 'x': 21.25, 'y': 7, 'z': 24, 'height': 3, 'width': 16, 'length': 4.5},
  'build5_3f_room3': {'floor': 3, 'build': 'build5', 'x': 14.5, 'y': 7, 'z': 24, 'height': 3, 'width': 16, 'length': 9},
  'build5_3f_room4': {'floor': 3, 'build': 'build5', 'x': 5.5, 'y': 7, 'z': 24, 'height': 3, 'width': 16, 'length': 9},
  'build5_3f_room5': {'floor': 3, 'build': 'build5', 'x': -3.5, 'y': 7, 'z': 24, 'height': 3, 'width': 16, 'length': 9},
  'build5_3f_room6': {'floor': 3, 'build': 'build5', 'x': -12.5, 'y': 7, 'z': 24, 'height': 3, 'width': 16, 'length': 9},
  'build5_3f_aisle2': {'floor': 3, 'build': 'build5', 'x': -19.25, 'y': 7, 'z': 26.25, 'height': 3, 'width': 11.5, 'length': 4.5},
  // build5_4f
  'build5_4f_room1': {
    'floor': 4,
    'build': 'build5',
  ...
  //   'length': 9
  // },
  'build5_4f_aisle1': {'floor': 4, 'build': 'build5', 'x': 21.25, 'y': 10, 'z': 24, 'height': 3, 'width': 16, 'length': 4.5},
  'build5_4f_room3': {
    'floor': 4,
    'build': 'build5',
    'x': 10,
  ...
  //   'length': 9
  // },
  'build5_4f_aisle2': {'floor': 4, 'build': 'build5', 'x': -19.25, 'y': 10, 'z': 26.25, 'height': 3, 'width': 11.5, 'length': 4.5},
  // build5_5f
  'build5_5f_room1': {'floor': 5, 'build': 'build5', 'x': 37, 'y': 13, 'z': 24, 'height': 3, 'width': 16, 'length': 9},
  'build5_5f_room1_###1': {'floor': 6, 'build': 'build5', 'x': 37, 'y': 16, 'z': 25.5, 'height': 5, 'width': 13, 'length': 9},
  'build5_5f_room1_###2': {'floor': 6, 'build': 'build5', 'x': 37, 'y': 21, 'z': 24, 'radius': 3, 'shape': 'ball'},
  'build5_5f_room2': {
    'floor': 5,
    'build': 'build5',
    'x': 25.75,
  ...
  //   'length': 9
  // },
  'build5_5f_room5': {'floor': 5, 'build': 'build5', 'x': -3.5, 'y': 13, 'z': 24, 'height': 3, 'width': 16, 'length': 9},
  'build5_5f_room6': {'floor': 5, 'build': 'build5', 'x': -12.5, 'y': 13, 'z': 24, 'height': 3, 'width': 16, 'length': 9},
  'build5_5f_aisle2': {'floor': 5, 'build': 'build5', 'x': -19.25, 'y': 13, 'z': 26.25, 'height': 3, 'width': 11.5, 'length': 4.5},

  // build6
  'build6_base1': {'build': 'build6', 'x': -60, 'y': 0, 'z': 0, 'height': 1, 'width': 35, 'length': 25},
  'build6_elevator1': {'build': 'build6', 'x': -56, 'y': 1, 'z': -8, 'height': 18, 'width': 3, 'length': 3},
  'build6_stair1': {'build': 'build6', 'x': -51, 'y': 1, 'z': -8, 'height': 18, 'width': 3, 'length': 7},
  'build6_stair2': {'build': 'build6', 'x': -73.75, 'y': 0, 'z': 0, 'height': 17, 'width': 16, 'length': 2.5},
  // build6_1f
  'build6_1f_toilet1': {'floor': 1, 'build': 'build6', 'x': -52.5, 'y': 1, 'z': -13.5, 'height': 3, 'width': 8, 'length': 10},
  'build6_1f_room1': {'floor': 1, 'build': 'build6', 'x': -60, 'y': 1, 'z': 11.5, 'height': 6, 'width': 12, 'length': 25},
  'build6_1f_room2': {'floor': 1, 'build': 'build6', 'x': -57.5, 'y': 1, 'z': -0.5, 'height': 3, 'width': 12, 'length': 10},
  'build6_1f_room3': {'floor': 1, 'build': 'build6', 'x': -67.5, 'y': 1, 'z': -0.5, 'height': 3, 'width': 12, 'length': 10},
  'build6_1f_room4': {'floor': 1, 'build': 'build6', 'x': -67.5, 'y': 1, 'z': -12, 'height': 3, 'width': 11, 'length': 10},
  'build6_1f_room5': {'floor': 1, 'build': 'build6', 'x': -60, 'y': 1, 'z': -12, 'height': 3, 'width': 11, 'length': 5},
  // build6_2f
  'build6_2f_toilet1': {'floor': 1, 'build': 'build6', 'x': -52.5, 'y': 4, 'z': -13.5, 'height': 3, 'width': 8, 'length': 10},
  'build6_2f_room2': {'floor': 1, 'build': 'build6', 'x': -62.5, 'y': 4, 'z': -0.5, 'height': 3, 'width': 12, 'length': 20},
  'build6_2f_room2_###1': {'floor': 1, 'build': 'build6', 'x': -65, 'y': 4, 'z': -12, 'height': 3, 'width': 11, 'length': 15},
  // build6_3f
  'build6_3f_toilet1': {'floor': 1, 'build': 'build6', 'x': -52.5, 'y': 7, 'z': -13.5, 'height': 3, 'width': 8, 'length': 10},
  'build6_3f_room1_###1': {'floor': 3, 'build': 'build6', 'x': -60, 'y': 7, 'z': 11.5, 'height': 3, 'width': 12, 'length': 25},
  'build6_3f_room1': {'floor': 3, 'build': 'build6', 'x': -62.5, 'y': 7, 'z': -0.5, 'height': 3, 'width': 12, 'length': 20},
  'build6_3f_room1_###2': {'floor': 3, 'build': 'build6', 'x': -65, 'y': 7, 'z': -12, 'height': 3, 'width': 11, 'length': 15},
  // build6_4f
  'build6_4f_toilet1': {'floor': 1, 'build': 'build6', 'x': -52.5, 'y': 10, 'z': -13.5, 'height': 3, 'width': 8, 'length': 10},
  'build6_4f_room3': {'floor': 4, 'build': 'build6', 'x': -52.5, 'y': 10, 'z': 12.5, 'height': 3, 'width': 10, 'length': 10},
  'build6_4f_room4': {'floor': 4, 'build': 'build6', 'x': -65, 'y': 10, 'z': 12.5, 'height': 3, 'width': 10, 'length': 15},
  'build6_4f_room5': {'floor': 4, 'build': 'build6', 'x': -50, 'y': 10, 'z': 6.5, 'height': 3, 'width': 2, 'length': 5},
  'build6_3f_room1_###3': {'floor': 4, 'build': 'build6', 'x': -62.5, 'y': 10, 'z': 0.5, 'height': 3, 'width': 14, 'length': 20},
  'build6_3f_room1_###4': {'floor': 4, 'build': 'build6', 'x': -65, 'y': 10, 'z': -12, 'height': 3, 'width': 11, 'length': 15},
  // build6_5f
  'build6_5f_toilet1': {'floor': 1, 'build': 'build6', 'x': -52.5, 'y': 13, 'z': -13.5, 'height': 3, 'width': 8, 'length': 10},
  'build6_5f_room1_###1': {'floor': 5, 'build': 'build6', 'x': -60, 'y': 13, 'z': 11.5, 'height': 3, 'width': 12, 'length': 25},
  'build6_5f_room1': {'floor': 5, 'build': 'build6', 'x': -62.5, 'y': 13, 'z': -0.5, 'height': 3, 'width': 12, 'length': 20},
  'build6_5f_room1_###2': {'floor': 5, 'build': 'build6', 'x': -65, 'y': 13, 'z': -12, 'height': 3, 'width': 11, 'length': 15},

  // build7
  'build7_build_###base1': {'build': 'build7', 'x': -75, 'y': 0, 'z': 60, 'height': 1, 'width': 50, 'length': 35},
  'build7_build_###base2': {'build': 'build7', 'x': -55, 'y': 0, 'z': 60, 'height': 1, 'width': 37, 'length': 5},
  'build7_toilet1': {'build': 'build7', 'x': -82.5, 'y': 1, 'z': 38, 'height': 3, 'width': 5, 'length': 5},
  'build7_toilet2': {'build': 'build7', 'x': -67.5, 'y': 1, 'z': 38, 'height': 3, 'width': 5, 'length': 5},
  'build7_build': {'build': 'build7', 'x': -75, 'y': 1, 'z': 60, 'height': 10, 'width': 50, 'length': 35},
  'build7_build_###build_extend1': {'build': 'build7', 'x': -55, 'y': 10, 'z': 60, 'height': 1, 'width': 28, 'length': 5},
  ...
  'build7_build_###colunm_2': {'build': 'build7', 'x': -53.5, 'y': 1, 'z': 67, 'height': 10, 'width': 1, 'length': 1},
  'build7_build_###colunm_3': {'build': 'build7', 'x': -53.5, 'y': 1, 'z': 62, 'height': 10, 'width': 1, 'length': 1},
  'build7_build_###colunm_4': {'build': 'build7', 'x': -53.5, 'y': 1, 'z': 58, 'height': 10, 'width': 1, 'length': 1},
  'build7_build_###colunm_5': {'build': 'build7', 'x': -53.5, 'y': 1, 'z': 53, 'height': 10, 'width': 1, 'length': 1},
  'build7_build_###colunm_6': {'build': 'build7', 'x': -53.5, 'y': 1, 'z': 48, 'height': 10, 'width': 1, 'length': 1},

  // build8
  'build8_base1': {'build': 'build8', 'x': 70, 'y': 0, 'z': -85, 'height': 1, 'width': 35, 'length': 23},
  'build8_base2': {'build': 'build8', 'x': 88, 'y': 0, 'z': -72.5, 'height': 1, 'width': 25, 'length': 13},
  'build8_base3': {'build': 'build8', 'x': 70, 'y': 0, 'z': -63.75, 'height': 1, 'width': 7.5, 'length': 23},
  'build8_room1': {'build': 'build8', 'x': 70, 'y': 1, 'z': -85, 'height': 6, 'width': 35, 'length': 23},
  'build8_room2': {'build': 'build8', 'x': 88, 'y': 1, 'z': -72.5, 'height': 4, 'width': 25, 'length': 13},
  'build8_room3': {'build': 'build8', 'x': 70, 'y': 0, 'z': -105, 'height': 3, 'width': 5, 'length': 23},

  // build9
  'build9_stair1': {'build': 'build9', 'x': 80, 'y': 0, 'z': -45, 'height': 21, 'width': 6, 'length': 6},
  // build9_1f
  'build9_1f': {'floor': 1, 'build': 'build9', 'x': 77, 'y': 0, 'z': -42, 'height': 3, 'width': 0, 'length': 0},
  'build9_1f_###1': {'floor': 1, 'build': 'build9', 'x': 70.5, 'y': 0, 'z': -47.5, 'height': 3, 'width': 11, 'length': 13},
  'build9_1f_###2': {'floor': 1, 'build': 'build9', 'x': 82.5, 'y': 0, 'z': -35.5, 'height': 3, 'width': 13, 'length': 11},
  // build9_2f
  'build9_2f': {'floor': 2, 'build': 'build9', 'x': 77, 'y': 3, 'z': -42, 'height': 3, 'width': 0, 'length': 0},
  'build9_2f_###1': {'floor': 2, 'build': 'build9', 'x': 70.5, 'y': 3, 'z': -47.5, 'height': 3, 'width': 11, 'length': 13},
  'build9_2f_###2': {'floor': 2, 'build': 'build9', 'x': 82.5, 'y': 3, 'z': -35.5, 'height': 3, 'width': 13, 'length': 11},
  // build9_3f
  'build9_3f': {'floor': 3, 'build': 'build9', 'x': 77, 'y': 6, 'z': -42, 'height': 3, 'width': 0, 'length': 0},
  'build9_3f_###1': {'floor': 3, 'build': 'build9', 'x': 70.5, 'y': 6, 'z': -47.5, 'height': 3, 'width': 11, 'length': 13},
  'build9_3f_###2': {'floor': 3, 'build': 'build9', 'x': 82.5, 'y': 6, 'z': -35.5, 'height': 3, 'width': 13, 'length': 11},
  // build9_4f
  'build9_4f': {'floor': 4, 'build': 'build9', 'x': 77, 'y': 9, 'z': -42, 'height': 3, 'width': 0, 'length': 0},
  'build9_4f_###1': {'floor': 4, 'build': 'build9', 'x': 70.5, 'y': 9, 'z': -47.5, 'height': 3, 'width': 11, 'length': 13},
  'build9_4f_###2': {'floor': 4, 'build': 'build9', 'x': 82.5, 'y': 9, 'z': -35.5, 'height': 3, 'width': 13, 'length': 11},
  // build9_5f
  'build9_5f': {'floor': 5, 'build': 'build9', 'x': 77, 'y': 12, 'z': -42, 'height': 3, 'width': 0, 'length': 0},
  'build9_5f_###1': {'floor': 5, 'build': 'build9', 'x': 70.5, 'y': 12, 'z': -47.5, 'height': 3, 'width': 11, 'length': 13},
  'build9_5f_###2': {'floor': 5, 'build': 'build9', 'x': 82.5, 'y': 12, 'z': -35.5, 'height': 3, 'width': 13, 'length': 11},

  // facility
  'facility_courtyard1': {'x': 10, 'y': 0, 'z': -2, 'height': 0, 'width': 0, 'length': 0},
  'facility_courtyard2': {'x': 20, 'y': 0, 'z': 38, 'height': 0, 'width': 0, 'length': 0},
  'facility_gate': {'x': -30, 'y': 7, 'z': 100, 'height': 3, 'width': 8, 'length': 20},
  'facility_gate_###1': {'x': -37, 'y': 0, 'z': 100, 'height': 7, 'width': 6, 'length': 4},
  'facility_gate_###2': {'x': -23, 'y': 0, 'z': 100, 'height': 7, 'width': 6, 'length': 4},
  ...
  'facility_court1': {'x': 40, 'y': 0, 'z': -60, 'height': 0.1, 'width': 35, 'length': 30},
  'facility_court2': {'x': 0, 'y': 0, 'z': -62.5, 'height': 0.1, 'width': 30, 'length': 50},
  'facility_court3': {'x': -50, 'y': 0, 'z': -50, 'height': 0.1, 'width': 35, 'length': 30},
  'facility_court4': {
    'x': -60,
    'y': 0,
    'z': -85,
  ...
  'facility_recyclihgYard1': {'x': -80, 'y': 0, 'z': 0, 'height': 0.1, 'width': 35, 'length': 10},
  'facility_guardHouse': {'x': -44, 'y': 0, 'z': 100, 'height': 4, 'width': 5, 'length': 10},
  ...
  'facility_parkingLot1_###1': {'x': -78, 'y': 0, 'z': 87, 'height': 2, 'width': 2, 'length': 30},
  'facility_toilet1': {'x': -80, 'y': 0, 'z': 25.5, 'height': 3, 'width': 9, 'length': 11},
  'facility_electronic1': {'x': 28, 'y': 0, 'z': 98.5, 'height': 2, 'width': 3, 'length': 7},
  'facility_electronic1_###1': {'x': 23, 'y': 0, 'z': 99, 'height': 3, 'width': 2, 'length': 3},
  'facility_garbages1': {
    'x': 37,
    'y': 0,
    'z': 98.5,
  ...
  'facility_platform1': {'x': 0, 'y': 0, 'z': -135, 'height': 8, 'width': 6, 'length': 14},
  'facility_ground1': {'x': 0, 'y': 0, 'z': -105, 'height': 0.1, 'width': 50, 'length': 100},
  'facility_ground1_###1': {'x': 55, 'y': 0, 'z': -125, 'height': 0.1, 'width': 10, 'length': 15},
  'facility_parkingLot2': {'x': 23, 'y': 0, 'z': 75, 'height': 0.1, 'width': 30, 'length': 20},
  'facility_parkingLot3': {'x': 75, 'y': 0, 'z': -20, 'height': 0.1, 'width': 15, 'length': 20},
  ...
  'wall_###6': {'x': -85.15, 'y': 0, 'z': 0, 'height': 2, 'width': 35, 'length': 0.3},
  'wall_###7': {
    'x': 55,
    'y': 0,
    'z': 57,
  ...
  'wall_###13': {'x': 63.5, 'y': 0, 'z': -129.85, 'height': 2, 'width': 19, 'length': 0.3},
  'hill': {
    'x': 0,
    'y': -15,
    'z': -162,
...
class _ZHSH3DMapPageState extends State<ZHSH3DMapPage> with TickerProviderStateMixin<ZHSH3DMapPage> {
  ...
  double _gateSlideDoor = settingData['general']['position']['gateSlideDoor'] ?? 0;
    ...
    _windowSizeTimer = Timer.periodic(const Duration(milliseconds: 100), (timer) {
      if (screenSize != MediaQuery.of(context).size) {
        if (MediaQuery.of(context).size.width > deskopModeWidth) {
          ...
          height = MediaQuery.of(context).size.height - (_fullScreen || _embededMode ? 0 : AppBar().preferredSize.height);
        } else {
          width = MediaQuery.of(context).size.width;
          height = (MediaQuery.of(context).size.height - AppBar().preferredSize.height) * 2 / 3;
        }
            ...
            children: [
              ...
              ListTile(
                ...
                trailing: IconButton(
                  ...
                  onPressed: () {
                    html.window.navigator.clipboard?.writeText('https://jhihyulin.live/zhsh3dmap?embededMode=true');
                  },
                ),
              ),
            ],
  ...
  dynamic searchRecommend(String arg, bool editcomplete) {
    ...
    for (var i in settingData['object']['set'].keys) {
      ...
      // name search
      if (settingData['general']['search']['nameSearch'] && settingData['object']['set'][i]['nameSearch'] != false) {
        if (settingData['object']['set'][i]['name']!.toLowerCase().contains(arg.toLowerCase())) {
      ...
      // keyword search
      if (settingData['general']['search']['keywordSearch'] && settingData['object']['set'][i]['keywordSearch'] != false) {
  ...
  initPage() {
    ...
    camera.position.set(settingData['camera']['x'], settingData['camera']['y'], settingData['camera']['z']);
    camera.lookAt(Vector3(settingData['camera']['focusX'], settingData['camera']['focusY'], settingData['camera']['focusZ']));
    ...
    controls.minPolarAngle = settingData['controls']['minPolarAngle'] * three.Math.pi / 180; // radians
    controls.maxPolarAngle = settingData['controls']['maxPolarAngle'] * three.Math.pi / 180; // radians
    controls.target.set(settingData['camera']['focusX'], settingData['camera']['focusY'], settingData['camera']['focusZ']);
    ...
    for (var i in mapData.keys) {
      ...
      if (mapData[i]!['shape'] == 'ball') {
        ...
        mesh.scale.set(mapData[i]!['length'], mapData[i]!['height'], mapData[i]!['width']);
      }
  ...
  focus(String buildingName) {
    ...
    var tarCameraPosition = three.Vector3(
      objectX >= 0 ? objectX + settingData['camera']['focusIncreaseX'] : objectX - settingData['camera']['focusIncreaseX'],
      objectY + (objectHeight / 2) + settingData['camera']['focusIncreaseY'],
      objectZ >= 0 ? objectZ + settingData['camera']['focusIncreaseZ'] : objectZ - settingData['camera']['focusIncreaseZ'],
    );
    _navigatorTimer = Timer.periodic(const Duration(milliseconds: 50), (timer) {
      ...
      if (distance < 1) {
        cameraPosition.set(tarCameraPosition.x, tarCameraPosition.y, tarCameraPosition.z);
        timer.cancel();
        controls.autoRotate = settingData['controls']['autoRotate'];
        return;
      } else {
    ...
    for (var i in scene.children) {
      if (i is three.Mesh) {
        ...
        if (i.name.replaceAll(RegExp(r'_###.*'), '') == buildingName) {
          ...
          i.material = three.MeshPhysicalMaterial({
            'color': settingData['object']['set'][i.name]!['color'] ?? settingData['buildings']['color'],
            'flatShading': true,
  ...
  resetCamera() {
    ...
    var tarCameraPosition = three.Vector3(settingData['camera']['x'], settingData['camera']['y'], settingData['camera']['z']);
    _navigatorTimer = Timer.periodic(const Duration(milliseconds: 50), (timer) {
      if (!mounted || disposed) {
        timer.cancel();
        return;
  ...
  setGateSlideDoor(double value) {
    ...
    for (var i in li) {
      var mesh = scene.getObjectByName('facility_gate_slidedoor_###$i') as three.Mesh;
      mesh.position.setX(mapData['facility_gate_slidedoor_###$i']!['x']! - value);
      if (kDebugMode) {
